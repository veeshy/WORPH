function [MCNP,cellcounter,planecounter]=SSS_Bound1to2x1(MCNP,geom,cellcounter,planecounter)
...
[Fuel_Hex_Cords, TieTube_Tally, hexradX, hexradY] =  CordsandSize(MCNP);
   ...
   %outside
    ...
    MCNP.Boundary.Plane_String{1}=['surf ', num2str(planecounter) ' hexyc ', '0 0 ',num2str(ctc/2 +edgelength/2,'%.4f'), ' \n' ];
