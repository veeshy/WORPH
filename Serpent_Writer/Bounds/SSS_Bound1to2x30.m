function [MCNP,cellcounter,planecounter]=SSS_Bound1to2x30(MCNP,geom,cellcounter,planecounter)
...
[Fuel_Hex_Cords, TieTube_Tally, hexradX, hexradY] =  CordsandSize(MCNP);
   ...
   %outside
    ...
    MCNP.Boundary.Plane_String{1}=['surf ', num2str(planecounter) ' hexxc ', '0 0 ',num2str((ftf*4.5+.00001),'%.4f'), ' \n' ];
