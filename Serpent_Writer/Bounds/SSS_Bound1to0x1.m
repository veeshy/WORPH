function [MCNP,cellcounter,planecounter]=SSS_Bound1to0(MCNP,geom,cellcounter,planecounter)
...
[Fuel_Hex_Cords, TieTube_Tally, hexradX, hexradY] =  CordsandSize(MCNP);
   ...
   %outside
    ...
    boundY=ctc/2+edgelength/2+.000001;
    boundX=ftf/2+.000001;
    MCNP.Boundary.Plane_String{1}=['surf ', num2str(planecounter) ' hexxc ', '0 0 ',num2str(ftf/2+.00001),'%.4f \n' ];
end
