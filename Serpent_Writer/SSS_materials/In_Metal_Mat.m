function  [MCNP]  = In_Metal_Mat(MCNP)


if isfield(MCNP.Material.normal.In_Metal,'Poison_Frac')
Poison_load = MCNP.Material.normal.In_Metal.Poison_Frac; % pmm loaded
else
Poison_load=0;
end

if isfield(MCNP.Material.normal.In_Metal,'Poison_Type')
Poison_Type = MCNP.Material.normal.In_Metal.Poison_Type;
else 
   Poison_Type=0;
end
...
if exist('Poison')
MCNPpre.Material.normal.In_Metal.Material_String = strcat(TT_Metal,Poison);
else 
MCNPpre.Material.normal.In_Metal.Material_String =TT_Metal;
end
