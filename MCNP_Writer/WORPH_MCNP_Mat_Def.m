...
MCNP.Material.normal.Fuel.Material_String= ...
    ['74182.84c 0.0001871206 &\n'...
'74183.84c 0.0001010451 &\n'...
'74184.84c 0.0239567992 &\n'...
'74186.84c 0.0002007486 &\n'...
'90232.84c 0.0008523070 &\n'...
' 8016.84c 0.0284102344 &\n'...
'92235.84c 0.0026371800 &\n'...
'92238.84c 0.0107156302\n'  ];
%any material can have an SAB string, it is optional
MCNP.Material.normal.Fuel.Material_SAB_String=  'o2/u.10t\n' ;
%enriched W
MCNP.Material.normal.In_Clad.Material_String=...
    ['74182.84c 0.0001815070 &\n'...
'74183.84c 0.0000980138 &\n'...
'74184.84c 0.0232380952 &\n'...
'74186.84c 0.0001947261  \n'];
%enriched W
...
'74184.84c 0.0232380952 &\n'...
'74186.84c 0.0001947261 \n'];
MCNP.Material.normal.Coolant.Material_String= '1001.80c -1\n';
MCNP.Material.normal.Coolant.Material_SAB_String='hpara.10t\n';
%Tietubes
MCNP.Material.normal.In_Cool.Material_String='1001.80c -1\n';
MCNP.Material.normal.In_Cool.Material_SAB_String='hpara.10t\n';
...
%any material can have an SAB string, it is optional
MCNP.Material.poisoned.Fuel.Material_SAB_String=  'o2/u.107\n' ;
%enriched W
...
MCNP.Material.poisoned.Moderator.Material_String=...
    ['40090.81c  -0.496737654 &\n'...
'40091.81c  -0.109532499 &\n'...
'40092.81c  -0.169263275 &\n'...
'40094.81c  -0.175268497 &\n'...
'40096.81c  -0.028838549 &\n'...
'1001.81c  -0.020312838 &\n'...
'1002.81c  -4.66879E-05\n'];
