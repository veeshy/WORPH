function [MCNP,cellcounter,planecounter]=Bound3to1x3(MCNP,geom,cellcounter,planecounter)
...
num2str(-(ftf/2),'%.4f'),' ' num2str((edgelength)/2,'%.4f'), ' -10 0 0 20 '...
num2str(-(ftf+.00001),'%.4f'),' 0 0'];
end
